...
static void test_save_ico(void) {
    GError* error = NULL;
    GdkPixbuf *ref, *ref2;
    GdkPixbuf* pixbuf;
...
static void test_save_options(void) {
    GdkPixbuf* ref;
    ...
    gdk_pixbuf_save(ref, "pixbuf-save-options", "png", &error, "tEXt::option1", "Some text to transport via option",
