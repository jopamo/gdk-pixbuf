...
static void test_no_construct_properties(void) {
...
static void test_pixels(void) {
    ...
    GdkPixbuf* pixbuf = g_object_new(GDK_TYPE_PIXBUF, "width", WIDTH, "height", HEIGHT, "rowstride", ROWSTRIDE,
                                     "bits-per-sample", 8, "n-channels", 3, "has-alpha", TRUE, "pixels", pixels, NULL);
...
static void test_bytes(void) {
    ...
    GdkPixbuf* pixbuf =
        g_object_new(GDK_TYPE_PIXBUF, "width", WIDTH, "height", HEIGHT, "rowstride", ROWSTRIDE, "bits-per-sample", 8,
                     "n-channels", 3, "has-alpha", TRUE, "pixel-bytes", bytes, NULL);
