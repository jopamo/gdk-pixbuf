...
static void test_short_gif_write(void) {
    GdkPixbufLoader* loader;
    GIOChannel* channel =
        g_io_channel_new_file(g_test_get_filename(G_TEST_DIST, "test-animation.gif", NULL), "r", NULL);
...
static void test_load_first_frame(void) {
    GIOChannel* channel;
