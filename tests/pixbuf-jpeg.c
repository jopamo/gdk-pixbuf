...
static void test_inverted_cmyk_jpeg(void) {
    GError* error = NULL;
    GdkPixbuf *ref, *ref2;
    gboolean ret;
...
static void test_type9_rotation_exif_tag(void) {
    GError* error = NULL;
...
static void test_bug_775218(void) {
    GError* error = NULL;
    GdkPixbuf* ref;
...
static void test_at_size(void) {
    ...
    ref = gdk_pixbuf_new_from_file_at_size(g_test_get_filename(G_TEST_DIST, "bug753605-atsize.jpg", NULL), 50, 50,
                                           &error);
    g_assert_no_error(error);
    g_object_unref(ref);
}

static void test_jpeg_markers(void) {
...
static void test_jpeg_fbfbfbfb(void) {
    GdkPixbufLoader* loader;
    GdkPixbuf* pixbuf;
    GError* error = NULL;
    gchar* contents;
