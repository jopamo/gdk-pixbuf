...
static gboolean gdk_pixbuf__gdip_image_save_JPEG_to_callback(GdkPixbufSaveFunc save_func,
                                                             gpointer user_data,
                                                             GdkPixbuf* pixbuf,
                                                             gchar** keys,
                                                             gchar** values,
...
static gboolean gdk_pixbuf__gdip_image_save_JPEG(FILE* f,
                                                 GdkPixbuf* pixbuf,
                                                 gchar** keys,
                                                 gchar** values,
                                                 GError** error) {
...
static gboolean gdk_pixbuf__gdip_is_save_option_supported_JPEG(const gchar* option_key) {
...
MODULE_ENTRY(fill_info)(GdkPixbufFormat* info) {
    static const GdkPixbufModulePattern signature[] = {{"\xff\xd8", NULL, 100}, /* JPEG */
                                                       {NULL, NULL, 0}};
