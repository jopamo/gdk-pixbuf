...
static void gdk_pixbuf_ani_anim_get_size(GdkPixbufAnimation* anim, int* width, int* height);
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
static GdkPixbufAnimationIter* gdk_pixbuf_ani_anim_get_iter(GdkPixbufAnimation* anim, const GTimeVal* start_time);
G_GNUC_END_IGNORE_DEPRECATIONS

G_DEFINE_TYPE(GdkPixbufAniAnim, gdk_pixbuf_ani_anim, GDK_TYPE_PIXBUF_ANIMATION)

static void gdk_pixbuf_ani_anim_init(GdkPixbufAniAnim* anim) {}
...
static void iter_restart(GdkPixbufAniAnimIter* iter) {
...
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
static gboolean gdk_pixbuf_ani_anim_iter_advance(GdkPixbufAnimationIter* iter, const GTimeVal* current_time);
G_GNUC_END_IGNORE_DEPRECATIONS

G_DEFINE_TYPE(GdkPixbufAniAnimIter, gdk_pixbuf_ani_anim_iter, GDK_TYPE_PIXBUF_ANIMATION_ITER);

static void gdk_pixbuf_ani_anim_iter_init(GdkPixbufAniAnimIter* anim) {}
...
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
static gboolean gdk_pixbuf_ani_anim_iter_advance(GdkPixbufAnimationIter* anim_iter, const GTimeVal* current_time) {
    GdkPixbufAniAnimIter* iter;
    gint elapsed;
    gint tmp;
    gint old;
    ...
    for (tmp = 0; tmp < iter->ani_anim->n_frames; tmp++) {
        if (iter->position >= iter->elapsed && iter->position < (iter->elapsed + iter->ani_anim->delay[tmp]))
            break;
...
int gdk_pixbuf_ani_anim_iter_get_delay_time(GdkPixbufAnimationIter* anim_iter) {
    GdkPixbufAniAnimIter* iter;
...
GdkPixbuf* gdk_pixbuf_ani_anim_iter_get_pixbuf(GdkPixbufAnimationIter* anim_iter) {
    GdkPixbufAniAnimIter* iter;
    gint frame;
...
static gboolean gdk_pixbuf_ani_anim_iter_on_currently_loading_frame(GdkPixbufAnimationIter* anim_iter) {
    GdkPixbufAniAnimIter* iter;
    gint frame;
