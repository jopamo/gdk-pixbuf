...
static void gdk_pixbuf_gdip_anim_get_size(GdkPixbufAnimation* anim, int* width, int* height);
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
static GdkPixbufAnimationIter* gdk_pixbuf_gdip_anim_get_iter(GdkPixbufAnimation* anim, const GTimeVal* start_time);
G_GNUC_END_IGNORE_DEPRECATIONS

G_DEFINE_TYPE(GdkPixbufGdipAnim, gdk_pixbuf_gdip_anim, GDK_TYPE_PIXBUF_ANIMATION);

static void gdk_pixbuf_gdip_anim_init(GdkPixbufGdipAnim* anim) {}
...
static gboolean gdk_pixbuf_gdip_anim_is_static_image(GdkPixbufAnimation* animation) {
    ...
    return (gdip_anim->frames != NULL && gdip_anim->frames->next == NULL);
}
...
static void iter_clear(GdkPixbufGdipAnimIter* iter) {
    iter->current_frame = NULL;
}

static void iter_restart(GdkPixbufGdipAnimIter* iter) {
    iter_clear(iter);
...
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
static gboolean gdk_pixbuf_gdip_anim_iter_advance(GdkPixbufAnimationIter* iter, const GTimeVal* current_time);
G_GNUC_END_IGNORE_DEPRECATIONS

G_DEFINE_TYPE(GdkPixbufGdipAnimIter, gdk_pixbuf_gdip_anim_iter, GDK_TYPE_PIXBUF_ANIMATION_ITER);

static void gdk_pixbuf_gdip_anim_iter_init(GdkPixbufGdipAnimIter* iter) {}
...
G_GNUC_BEGIN_IGNORE_DEPRECATIONS
static gboolean gdk_pixbuf_gdip_anim_iter_advance(GdkPixbufAnimationIter* anim_iter, const GTimeVal* current_time) {
    GdkPixbufGdipAnimIter* iter;
    gint elapsed;
    gint loop;
    GList* tmp;
...
int gdk_pixbuf_gdip_anim_iter_get_delay_time(GdkPixbufAnimationIter* anim_iter) {
    GdkPixbufFrame* frame;
    GdkPixbufGdipAnimIter* iter;
...
GdkPixbuf* gdk_pixbuf_gdip_anim_iter_get_pixbuf(GdkPixbufAnimationIter* anim_iter) {
    GdkPixbufGdipAnimIter* iter;
    GdkPixbufFrame* frame;
...
static gboolean gdk_pixbuf_gdip_anim_iter_on_currently_loading_frame(GdkPixbufAnimationIter* anim_iter) {
    GdkPixbufGdipAnimIter* iter;
